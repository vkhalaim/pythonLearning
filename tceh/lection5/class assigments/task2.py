...
# можно сделать проверки на "возмонжость" построить данную фигуру с такими сторонами. # noqa E501
...
class Shape(object):
    ...
    def __init__(self, *sides):
        ...
        if (sides_qty < 1) and (sides_qty > 4):
            raise ValueError(
                'Ошибка при инициализации фигуры! Кол-во сторон {},'
...
class Triangle(Shape):
    ...
    def __init__(self, *sides):
        ...
        if sides_qty != 3:
            raise ValueError(
                'Ошибка при инициализации треугольника!'
        ...
        if two_sides_sum <= larger_side:
            raise ValueError(
                'Ошибка при инициализации треугольника!'
                'Со сторонами такой длины сторон'
    ...
    def _calc_sqr(self):
        ...
        return math.sqrt(
            half_per * (half_per - self.sides[0]) * (half_per - self.sides[1])
            * (half_per - self.sides[2])
        )
...
class Polygon(Shape):
    ...
    def __init__(self, *sides):
        ...
        if sides_qty != 4:
            raise ValueError(
                'Ошибка при инициализации четырехугольника!'
    ...
    def _calc_sqr(self):
        return 'Рассчитать площадь произвольного' \
